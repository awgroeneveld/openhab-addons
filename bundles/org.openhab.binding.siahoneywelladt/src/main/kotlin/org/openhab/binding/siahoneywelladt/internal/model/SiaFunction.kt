...
enum class SiaFunction(val code: Int, val needsAcknowledge: Boolean, text: String, val eventType: SiaEventHandlerType) {
    ...
    ALT_ACKNOWLEDGE(0x08, false, "Acknowledge", SiaEventHandlerType.MESSAGELESS),
    REJECT(0x39, false, "Reject", SiaEventHandlerType.MESSAGELESS),
    ALT_REJECT(0x09, false, "Reject", SiaEventHandlerType.MESSAGELESS),

    // INFO BLOCKS
    CONTROL(0x43, false, "Control", SiaEventHandlerType.UNKNOWN),
    ENVIRONMENTAL(0x45, true, "Environmental", SiaEventHandlerType.UNKNOWN),
    NEW_EVENT(0x4E, true, "New event", SiaEventHandlerType.REGULAR),
    OLD_EVENT(0x4F, true, "Old event", SiaEventHandlerType.REGULAR),
    PROGRAM(0x50, true, "Program", SiaEventHandlerType.UNKNOWN),
    ...
    LISTEN_IN(0x4C, true, "Listen-In", SiaEventHandlerType.UNKNOWN),
    VCHN_REQUEST(0x56, true, "Video channel request", SiaEventHandlerType.UNKNOWN),
    VCHN_FRAME(0x76, true, "Video channel frame data", SiaEventHandlerType.UNKNOWN),
